...
__all__ = ['TokenNotFoundError', 'Tokenizer', 'Streamer']
...
class Tokenizer:
    ...
    def encode(self, contents: Iterable[str], special_tokens: Container[str] | None = None, device: DeviceLikeType | None = None) -> Tensor:
        ...
        return torch.tensor([_encode(tokens) for tokens in tokens_list], dtype=torch.long, device=device)
